...
($r = 18 -- 22$~\AA) particles, which may be metastable relative to
cuboctahedra.
...
$\text{CN}=7$ and $\text{CN}=11$, respectively.
...
dependence on particle radius (see Figure \ref{fig:all-spect}.  This
